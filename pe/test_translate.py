...
from translate_double_enc import main as translate
...
if __name__ == '__main__':
    translation_settings = get_settings()

    translate(
        input1_file=open("data/test.src"),
        input2_file=open("data/test1.src"),
        output_file=open("models/test.trans", 'w'),
        translation_settings=translation_settings
        )
