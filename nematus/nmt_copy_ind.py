...
def build_decoder(tparams, options, y, ctx1, ctx2, init_state_gen, init_state_copy, dropout, x1_mask=None, x2_mask=None, 
    ...
    next_state = tensor.concatenate([next_state_gen, next_state_copy], axis=-1)
    # weighted averages of context, generated by attention module
    ctxs_gen = proj_gen[1]
    ctxs_copy = proj_copy[1]
    ctxs = tensor.concatenate([ctxs_gen, ctxs_copy], axis=-1)
    # weights (alignment matrix)
    opt_ret['dec_alphas1'] = proj_gen[2]
    opt_ret['dec_alphas2'] = proj_copy[2]
    alpha1 = proj_gen[2] # (timestep, batch_size, length x1) copy_score
    alpha2 = proj_copy[2]
    #cov1 = proj[4]
    #cov2 = proj[5]
